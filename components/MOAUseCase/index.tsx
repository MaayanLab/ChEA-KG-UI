        ...
        return (
            <Grid container spacing={2} >
                ...
                {props.description && <Grid item xs={12}>
                    ...
                    Explore the enriched regulatory TF subnetworks for the 30 most common mechanisms of action in the L1000 chemical perturbations dataset. The top 30 MOAs were identified from the unique drugs profiled
                    <Link href='https://maayanlab.cloud/l1000fwd/' 
                    target="_blank" 
                    rel="noopener noreferrer"><b> L1000 Firework Display</b></Link>.
                    (L1000 FWD) dataset. For each MOA, consensus gene sets were generated by retaining genes that appeared in at least 17% of all up or down  
                    <Link href='https://maayanlab.cloud/l1000fwd/download_page' 
                    target="_blank" 
                    rel="noopener noreferrer"><b> L1000 FWD Characteristic Direction</b></Link>.
                    gene sets for drugs in that MOA.
                    </Typography>
                </Grid>}
